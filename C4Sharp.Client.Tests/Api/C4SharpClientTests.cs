...
{
    public class C4SharpClientTests
    {
        private C4SharpClient _structurizrClient;

        [Fact]
        public void Test_Construction_WithTwoParameters()
        {
            _structurizrClient = new C4SharpClient("key", "secret");
        ...
        {
            _structurizrClient = new C4SharpClient("https://localhost", "key", "secret");
        ...
        public void Test_Construction_ThrowsAnException_WhenANullApiKeyIsUsed()
        {
            try
            {
                _structurizrClient = new C4SharpClient(null, "secret");
        ...
        public void Test_Construction_ThrowsAnException_WhenAnEmptyApiKeyIsUsed()
        {
            try
            {
                _structurizrClient = new C4SharpClient(" ", "secret");
                throw new TestFailedException();
            }
            catch (ArgumentException iae)
            {
        ...
        public void Test_Construction_ThrowsAnException_WhenANullApiSecretIsUsed()
        {
            try
            {
                _structurizrClient = new C4SharpClient("key", null);
                throw new TestFailedException();
            }
            catch (ArgumentException iae)
            {
        ...
        public void Test_Construction_ThrowsAnException_WhenAnEmptyApiSecretIsUsed()
        {
            try
            {
                _structurizrClient = new C4SharpClient("key", " ");
                throw new TestFailedException();
            }
            catch (ArgumentException iae)
            {
        ...
        public void Test_Construction_ThrowsAnException_WhenANullApiUrlIsUsed()
        {
            try
            {
                _structurizrClient = new C4SharpClient(null, "key", "secret");
                throw new TestFailedException();
            }
            catch (ArgumentException iae)
            {
