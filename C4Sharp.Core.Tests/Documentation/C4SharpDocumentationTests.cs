...
{
    public class C4SharpDocumentationTests : AbstractTestBase
    {
        ...
        private C4SharpDocumentationTemplate _template;

        public C4SharpDocumentationTests()
        {
            ...
            _template = new C4SharpDocumentationTemplate(Workspace);
        }
    
        [Fact]
        public void Test_Construction_ThrowsAnException_WhenANullWorkspaceIsSpecified() {
            try {
                new C4SharpDocumentationTemplate(null);
