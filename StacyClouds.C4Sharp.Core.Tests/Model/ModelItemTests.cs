...
namespace StacyClouds.C4Sharp.Core.Tests
{
    public class ModelItemTests : AbstractTestBase
    {
        ...
        public void Test_GetAllTags_NoTagAdded_RequiredTagsAreReturned()
        {
            ...
            // Relationship.GetRequiredTags() == new List<string> { StacyClouds.C4Sharp.Tags.Relationship, StacyClouds.C4Sharp.Tags.Synchronous }
            Assert.Equal(new List<string> { StacyClouds.C4Sharp.Tags.Relationship }, relation.GetAllTags());
        }
        ...
        public void Test_GetAllTags_TagsAdded_AddedTagsAndRequiredTagsAreReturned()
        {
            ...
            // Relationship.GetRequiredTags() == new List<string> { StacyClouds.C4Sharp.Tags.Relationship, StacyClouds.C4Sharp.Tags.Synchronous }
            Assert.Equal(new List<string> { StacyClouds.C4Sharp.Tags.Relationship, "TagA","TagB" }, relation.GetAllTags());
        }
